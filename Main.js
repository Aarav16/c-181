...
let data=[
    {
        "id":"1",
        "image":require('../asset/glasses.png')
    },
    {
        "id":"2",
        "image":require('../asset/glasses-round.png')

    },
    {
        "id":"3",
        "image":require('../asset/Frapp-02.png')
    },
    {
        "id":"4",
        "image":require('../asset/Frapp-03.png')
    },
    {
        "id":"5",
        "image":require('../asset/Frapp-04.png')
    },
    {
        "id":"6",
        "image":require('../asset/Frapp-05.png')
    },
    {
        "id":"7",
        "image":require('../asset/Frapp-06.png')
    },
    {
        "id":"8",
        "image":require('../asset/Frapp-07.png')
    },
    {
        "id":"9",
        "image":require('../asset/Frapp-08.png')
    },
    {
        "id":"10",
        "image":require('../asset/Frapp-09.png')
    },
]
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.headingContainer}>
                    ...
                    <Text style={styles.titleText}>FR</Text><Text style={styles.titleText}>APP</Text>
                    </View>
                    <View style={{flexDirection:'row',flexWrap:'wrap'}}>
                ...
                <View style={
                    ...
                    <ScrollView style={{flexDirection:"row"}}horizontol showsHorizontolScrollIndecator={false}>
                        {
                            data.map(filter_data=>{
                                return(
                                    ...
                                    onPress={()=>this.setState({current_filter:`filter_${filter_data.id}`})}>
                                        <Image source={filter_data.image}style={{height:32,widht:80}}/>
                                    </TouchableOpacity>
                                )
                            })
                        }
